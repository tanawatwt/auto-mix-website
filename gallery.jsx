...
function GalleryPage() {
  ...
  const all = [
    ...
    { cat: 'brake', label: 'ตรวจเช็คเบรค', size: '', src: 'images/brake/01-brake-inspect.jpg' },
    ...
    { cat: 'brake', label: 'ซ่อมเบรค', size: '', src: 'images/brake/02-brake-work.jpg' },
    ...
    { cat: 'brake', label: 'เบรค + ช่วงล่าง', size: '', src: 'images/brake/03-brake-suspension.jpg' },
